...
<MiddleVR>
    ...
    <DisplayManager Fullscreen="0" WindowBorders="0" ShowMouseCursor="0" VSync="1" SaveRenderTarget="0">
        ...
        <Viewport Name="Viewport_Front" Left="320" Top="200" Width="320" Height="200" Camera="CameraStereo_Front.Left" Stereo="0" StereoMode="0" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Left" Left="0" Top="200" Width="320" Height="200" Camera="CameraStereo_Left.Left" Stereo="0" StereoMode="0" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Right" Left="640" Top="200" Width="320" Height="200" Camera="CameraStereo_Right.Left" Stereo="0" StereoMode="0" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Floor" Left="320" Top="400" Width="320" Height="200" Camera="CameraStereo_Floor.Left" Stereo="0" StereoMode="0" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Ceiling" Left="320" Top="0" Width="320" Height="200" Camera="CameraStereo_Ceiling.Left" Stereo="0" StereoMode="0" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Front_Right" Left="1280" Top="200" Width="320" Height="200" Camera="CameraStereo_Front.Right" Stereo="0" StereoMode="3" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Left_Right" Left="960" Top="200" Width="320" Height="200" Camera="CameraStereo_Left.Right" Stereo="0" StereoMode="3" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Right_Right" Left="1600" Top="200" Width="320" Height="200" Camera="CameraStereo_Right.Right" Stereo="0" StereoMode="3" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Floor_Right" Left="1280" Top="400" Width="320" Height="200" Camera="CameraStereo_Floor.Right" Stereo="0" StereoMode="3" CompressSideBySide="0" StereoInvertEyes="0" />
        <Viewport Name="Viewport_Ceiling_Right" Left="1280" Top="0" Width="320" Height="200" Camera="CameraStereo_Ceiling.Right" Stereo="0" StereoMode="3" CompressSideBySide="0" StereoInvertEyes="0" />
    </DisplayManager>
    <Scripts>
