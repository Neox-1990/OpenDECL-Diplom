...
<xsl:template match="//openDECL:display-setup[@id='FiveSidedMono']">
<pvx>
<Process Type="client" />
<Process Type="render-server">
<xsl:for-each select="openDECL:display">
<Machine Environment="DISPLAY=:0" FullScreen="0" ShowBorders="0">
<xsl:attribute name="Name"><xsl:value-of select="../../openDECL:node/openDECL:graphics-device/openDECL:port[@id=current()/@portref]/../../@id" /></xsl:attribute>
